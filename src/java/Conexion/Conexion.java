...
public class Conexion {
    private static final String Base = "paginaweb";//NOMBRE DE LA BASE DE DATOS EN MYSQL
    private static final String usuario = "root";//USUARIO PARA INGRESAR A MYSQL
    private static final String contraseña = "daniela";//CONTRASEÑA PARA INGRESAR A MYSQL
